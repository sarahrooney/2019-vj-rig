...
bitScript = function() {
  ...
  function addImg() {
    var img = {
      ...
      // size: 2,
      id: "animemoon",
      width: document.getElementById("animemoon").dataset.width,
      height: document.getElementById("animemoon").dataset.height
    }
    imgs.push(img);
  ...
  function drawImg(selectImg){
    ...
    var newWidth = ((w / imgWidth) * imgWidth) * 3;
    var newHeight = ((h / imgHeight) * imgHeight) * 3;
