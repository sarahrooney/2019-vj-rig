...
bitScript = function() {
  ...
  function addImg() {
    var img = {
      ...
      // size: 2,
      id: "darkangel",
      width: document.getElementById("darkangel").dataset.width,
      height: document.getElementById("darkangel").dataset.height
    }
    imgs.push(img);
  ...
  function drawImg(selectImg){
    ...
    var newWidth = ((w / imgWidth) * imgWidth) * 1.5;
    var newHeight = ((h / imgHeight) * imgHeight) * 1.5;
