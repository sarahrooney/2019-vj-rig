bitScript = function() {
  ...
  var img = document.getElementById('illusion');
    ...
    if(_int == 1) {
      ...
      for (var i = 0; i < counter; i++) {
        for (var j = 0; j < counter; j++) {
          ctx2.drawImage(img, j * width - width/2, i * height - height/2, width, height)
        }
      }
    }
  }
  ...
  function drawBackground(_s) {
    ctx.background(0,150*_s,150*_s,0.05);
  }
}();
