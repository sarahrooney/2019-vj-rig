    ...
    if(_int == 1) {
      ...
      for (var i = 0; i < counter; i++) {
        for (var j = 0; j < counter; j++) {
          ctx2.drawImage(img, j * w/counter + w/counterDoubled - imgWidth/4, i * h/counter - h/counterDoubled, imgWidth, imgHeight)
        }
      }
    }
  }
